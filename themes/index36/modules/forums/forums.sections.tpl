...
<div class="container-xl py-4 py-md-5">
    ...
    <!-- BEGIN: CAT -->
    <div class="mb-4">
        <!-- IF {FORUMS_SECTIONS_ROW_SUBITEMS} -->
        ...
        <!-- ELSE -->
        <h3 class="h5 mb-3 border-bottom pb-2">
            <a href="{FORUMS_SECTIONS_ROW_SECTIONSURL}" class="text-decoration-none">
                {FORUMS_SECTIONS_ROW_TITLE}
            </a>
        </h3>
        <!-- ENDIF -->
...
{FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/inc/mskin.tpl"}<br>
/themes/index36/modules/forums/forums.sections.tpl
<!-- ENDIF -->
<!-- END: MAIN -->
