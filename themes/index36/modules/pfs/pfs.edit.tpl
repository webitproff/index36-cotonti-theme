			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8 col-xl-7">
					...
					<div class="card border shadow-sm">
						...
						<form id="edit" action="{PFS_ACTION}" method="post" class="needs-validation" novalidate>
							<div class="card-body">
								
								<div class="row g-4">
									
									<div class="col-12 col-sm-4">
										<label class="form-label fw-bold text-muted small">{PHP.L.File}</label>
									</div>
									...
									<div class="col-12 col-sm-4">
										<label class="form-label fw-bold text-muted small">{PHP.L.URL}</label>
									</div>
									<div class="col-12 col-sm-8">
										<div class="form-control-plaintext">
											<a href="{PFS_URL}" target="_blank" rel="noopener noreferrer" class="text-break">
												{PFS_URL}
											</a>
										</div>
									</div>
									...
									<div class="col-12 col-sm-4">
										<label class="form-label fw-bold text-muted small">{PHP.L.Size}</label>
									</div>
									<div class="col-12 col-sm-8">
										<div class="form-control-plaintext">
											{PFS_SIZE} {PHP.L.kb}
									...
									<div class="col-12">
										<label for="pfs_desc" class="form-label fw-bold">{PHP.L.Description}</label>
										{PFS_DESC}
									</div>
